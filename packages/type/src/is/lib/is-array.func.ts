...
/**
 * Checks if any `value` is an `Array` of an `'object'` generic `Type` type and `Array` instance.
 * Use the `guardArray()` function to type-guard `array` also.
 * @param value Any `value` to check if it's an `Array` of an `'object'` generic `Type` type and `Array` instance.
 * @returns boolean.
 */
