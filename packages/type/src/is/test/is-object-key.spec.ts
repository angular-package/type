...
describe(isObjectKey.name , () => {
  ...
  describe(`checks`, () => {
    ...
    describe(`primitive`, () => {
      ...
      describe(`object`, () => {
        // BigInt
        describe(`BigInt`, () => it(`${BIGINT_EXPECTATION}`, () => expect(isObjectKey(BIGINT_INSTANCE, 'bigint')).toBe(FALSE)));
        // Boolean
        describe(`Boolean`, () => {
        ...
        // Number
        describe(`Number`, () => it(`new Number(${NUMBER})`, () => expect(isObjectKey(NUMBER_NEW_INSTANCE, 'number')).toBe(FALSE)));
        // String
        describe(`String`, () => it(`new String(${STRING})`, () => expect(isObjectKey(STRING_NEW_INSTANCE, 'string')).toBe(FALSE)));
      });
    });
  });
});
