import { isArray } from '../../check/lib/is-array.func';
/**
 * Guard the `value` to be generic `Array` `Type`.
 * Use `isArray()` function to check ONLY.
 * @param value Generic `Type` type value to guard.
 * @returns boolean.
 ...
 */
export const guardArray = <Type>(value: Array<Type>): value is Array<Type> => isArray(value);
