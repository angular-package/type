 ...
 * `payload`.
 * @var Value A generic type variable `Value` by default `any` determines `value` parameter type.
 * @var Payload Generic type variable `Payload` indicates `payload` parameter type, which by default is `object`.
