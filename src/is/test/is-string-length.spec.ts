          ...
          testing
            ...
            .describe(`string`, () => {
              testing
                ...
                .it(`${stringFirstName}`, () => expect(isStringLength(stringFirstName, 13, max)).toBeTrue())
                .it(`${stringFirstName}`, () => expect(isStringLength(stringFirstName, 14, max)).toBeFalse())
                .it(`${stringFirstName}`, () => expect(isStringLength(stringFirstName, min, 12)).toBeFalse());
            })
            // symbol
            .describe(`symbol`, () => {
              testing
              ...
              testing
                ...
                .describe(`String`, () => {
                  testing
                    ...
                    .it(`new String(${stringFirstName})`, () => expect(isStringLength(stringInstance, 13, max)).toBeTrue())
                    .it(`new String(${stringFirstName})`, () => expect(isStringLength(stringInstance, 14, max)).toBeFalse())
                    .it(`new String(${stringFirstName})`, () => expect(isStringLength(stringInstance, min, 12)).toBeFalse());
                });
            });
        });
    });
