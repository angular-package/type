 ...
 * `value is Never<Function, Type>` and the `value` parameter of the provided `callback` function `ResultCallback` type.
 ...
 * supplied `callback` function and `payload` optional parameter of the `isNotFunction()` function from which it captures its value.
