...
/**
 * Checks if the `value` of a generic `Type` is not a `boolean` type and not an instance of `Boolean`.
 * @param value The `value` of any type, by default of type captured from the provided `value` to check.
 ...
 * @returns The return value is a `boolean` indicating whether the provided `value` is not `boolean` type or `Boolean` instance.
 * @angularpackage
 */
